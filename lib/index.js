...
var _ouiDomEvents = require('oui-dom-events');

var _ouiDomEvents2 = _interopRequireDefault(_ouiDomEvents);
...
var ReactDrag = function (_Component) {
  _inherits(ReactDrag, _Component);

  function ReactDrag(props) {
    _classCallCheck(this, ReactDrag);

    var _this = _possibleConstructorReturn(this, (ReactDrag.__proto__ || Object.getPrototypeOf(ReactDrag)).call(this, props));
  ...
  _createClass(ReactDrag, [{
    ...
    value: function componentWillUnmount() {
      ...
      _ouiDomEvents2.default.off(window, dragEventFor.move, this.handleDrag.bind(this));
      _ouiDomEvents2.default.off(window, dragEventFor.end, this.handleDragEnd.bind(this));
    ...
    value: function handleDragStart(e) {
      ...
      // Add event handlers
      _ouiDomEvents2.default.on(window, dragEventFor.move, this.handleDrag.bind(this));
      _ouiDomEvents2.default.on(window, dragEventFor.end, this.handleDragEnd.bind(this));
    ...
    value: function handleDrag(e) {
      ...
      var pageX = this.state.startX + (dragPoint.pageX - this.state.offsetX);
      var pageY = this.state.startY + (dragPoint.pageY - this.state.offsetY);
      var pos = getBoundPosition(pageX, pageY, this.props.bound, _reactDom2.default.findDOMNode(this));
      pageX = pos.pageX;
      pageY = pos.pageY;
      ...
      if (Array.isArray(this.props.grid)) {
        ...
        pageX = Math.abs(pageX - parseInt(this.state.pageX, 10)) >= this.props.grid[0] ? parseInt(this.state.pageX, 10) + this.props.grid[0] * directionX : this.state.pageX;

        pageY = Math.abs(pageY - parseInt(this.state.pageY, 10)) >= this.props.grid[1] ? parseInt(this.state.pageY, 10) + this.props.grid[1] * directionY : this.state.pageY;
      }
